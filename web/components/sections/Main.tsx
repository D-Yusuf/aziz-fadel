...
export default function Main() {
  return (
    <div className='flex flex-col '>
      <Navbar />
      <div className='flex justify-between items-end gap-4 font-extrabold   mt-14'>
        <div className='flex flex-col gap-10 max-w-1/2'>
          <h1 className='text-6xl leading-loose'>تدريبات وخطط تغذية مبنية على حقائق علمية </h1>
